...
export default function SuperAdminLogin() {
  ...
  const [curPage, setCurPage] = useState("SuperAdminLogin");
  ...
  return (
    <div className='w-screen h-screen bg-admin-page-header flex flex-col items-center justify-center'>
        {curPage === "SuperAdminLogin" &&  <div className='py-12 rounded-sm w-9/12 max-h-screen sm:w-5/12 md:w-4/12 lg:w-3/12 bg-white flex flex-col justify-start items-center gap-12
         form-shadow overflow-y-auto'>
            ...
            <header className='flex flex-col gap-2 w-full items-center'>
                ...
                <h2 className='text-sm font-normal text-stone-400'>Login as Super Admin</h2>
            </header>
